...
def check_car_battery_voltage(should_start, health, charging_disabled, msg):
  ...
  #   - keep battery within 67-80% State of Charge to preserve longevity
  if charging_disabled and (health is None or health.health.voltage > 11800) and msg.thermal.batteryPercent < 60:
    charging_disabled = False
    os.system('echo "1" > /sys/class/power_supply/battery/charging_enabled')
  elif not charging_disabled and (msg.thermal.batteryPercent > 80 or (health is not None and health.health.voltage < 11500 and not should_start)):
